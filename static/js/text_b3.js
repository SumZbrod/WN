    ...
    if (currentIndex < currentBatch.length) {
        ...
        if (item.block_type === "speach_line") {
            ...
            if (content.audioPath) {
                ...
                const voice_channel = item.content.voice_channel;
                textBox.dataset.voicePath = voice_path;
                // BGMSE_player(voice_path, voice_channel, 'voice');
                ...
                playButton.addEventListener('click', (event) => {
                    ...
                    // BGMSE_player(voice_path, 0, 'voice');
                });
                ...
                updateButton.addEventListener('click', async (event) => {
                    ...
                    try {
                        ...
                        trimAndSendAudio(voice_path, Player.mark, audioFilename);
...
// player.play();
// player.stop();
// player.change_audio('another.mp3');
